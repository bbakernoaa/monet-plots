...
class ReliabilityDiagramPlot(BasePlot):
    ...
    def plot(self,
        ...
        Args:
            data (pd.DataFrame): Either pre-binned reliability data or raw forecasts/observations.
        ...
        if forecasts_col and observations_col:
            if climatology is None:
                climatology = float(data[observations_col].mean())
            ...
            validate_dataframe(data, required_columns=[x_col, y_col])
            plot_data = data
