...
class WindQuiverPlot(BasePlot):
    ...
    def plot(self, u=None, v=None, ws=None, wdir=None, x=None, y=None, gridobj=None, **kwargs):
        ...
        Args:
            ...
            v (numpy.ndarray, optional): V-component (north-south) of wind. If provided, u must also be provided.
            ws (numpy.ndarray, optional): The wind speed data. If provided, wdir must also be provided.
            wdir (numpy.ndarray, optional): The wind direction data. If provided, ws must also be provided.
        ...
        self.ax.quiver(x[::15, ::15], y[::15, ::15], u[::15, ::15], v[::15, ::15], **kwargs)
