...
class ConditionalBiasPlot(BasePlot):
    ...
    def plot(self, 
        ...
        Args:
            data (pd.DataFrame): Paired obs/fcst data.
        ...
        """
        validate_dataframe(data, required_columns=[obs_col, fcst_col])
    ...
    def _plot_binned_bias(self, df, x_col, y_col, n_bins, label, **kwargs):
        ...
        binned = df.groupby(bins)[y_col].agg(['mean', 'std', 'count']).reset_index()
